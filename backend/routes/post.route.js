...
import { addComments, addNewPost, bookmarkPost, deletePost, getAllPost, getCommentsOfPost, likepost, unlikePost } from '../controller/post.controller.js'
...
postRouter.post("/bookmark/:id",isAuthenticated,bookmarkPost)
